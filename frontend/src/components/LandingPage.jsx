...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#202124] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="mb-8 animate-fade-in">
          <img 
            ...
            alt="127 Logo" 
            className="w-32 h-auto mx-auto mb-4 brightness-110"
          />
          <h1 className="text-5xl font-normal text-[#e8eaed] text-center tracking-tight">
            127.be
          </h1>
        </div>
        ...
        <div className="w-full max-w-2xl">
          ...
          {!showResults && (
            <div className="mt-8 text-center animate-fade-in">
              <p className="text-sm text-[#9aa0a6] mb-3">Populaire zoekopdrachten:</p>
              <div className="flex gap-2 justify-center flex-wrap">
                <button 
                  onClick={() => setSearchQuery('pixel')}
                  className="px-4 py-2 bg-[#303134] hover:bg-[#3c4043] text-[#e8eaed] rounded-full text-sm transition-colors border border-[#5f6368]"
                >
                  pixel test
                </button>
                <button 
      ...
      {/* Footer */}
      <footer className="py-4 border-t border-[#5f6368] bg-[#171717]">
